...
public class Main {
    ...
    static {
        ...
        solvers.put("SPT", new GreedySPTSolver());
        solvers.put("LPT", new GreedyLPTSolver());
        solvers.put("SRPT", new GreedySRPTSolver());
        solvers.put("LRPT", new GreedyLRPTSolver());
        solvers.put("EST_SPT", new GreedyEST_SPTSolver());
        solvers.put("EST_LPT", new GreedyEST_LPTSolver());
        solvers.put("EST_SRPT", new GreedyEST_SRPTSolver());
        solvers.put("EST_LRPT", new GreedyEST_LRPTSolver());
